...
app.get('/gioi-thieu', (req, res) => {
  res.render('about', {
    title: 'Giới Thiệu Phòng Văn hóa Xã hội Xã Khánh Trung'
  });
});
...
app.get('/dich-vu-cong/tra-cuu', (req, res) => {
  ...
  if (code) {
    ...
    result = {
      ...
      department: 'Văn phòng Xã hội Xã Khánh Trung'
    };
  }
...
app.listen(PORT, () => {
  console.log(`=======================================================`);
  console.log(` CỔNG THÔNG TIN ĐIỆN TỬ PHÒNG VĂN HOÁ XÃ HỘI XÃ KHÁNH TRUNG`);
